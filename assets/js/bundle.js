...
/***/ function(module, exports, __webpack_require__) {
	...
	var BoardStore = __webpack_require__(179);
	var Action = __webpack_require__(180);
	var Rect = __webpack_require__(181);
	var Dialog = __webpack_require__(183);
	var Board = React.createClass({displayName: "Board",
		...
		renderRect: function() {//set index
			var rects = this.state.rects.map(function(obj, index) {
				return (
					React.createElement(Rect, {key: index, index: index, rectInfo: obj})
				);
			});
		...
		renderResultDialog: function() {
			if (!this.state.isAlive) {//死翹翹
				return (
					React.createElement(Dialog, {message: "Game Over !!"})
				);
			}
			if (this.state.minecount=="0" && this.state.mine_num=="0") {//Win
				return (
					React.createElement(Dialog, {message: "Win!!"})
				);
			}
		},
		renderbombNum: function(){
			return(
					React.createElement("div", {className: "MineCount"}, "＊", this.state.mine_num)
				);
		},
		...
		render: function() {
			return (
				React.createElement("div", null, 
					this.renderbombNum(), 
					React.createElement("div", {id: "abc", className: "board"}, 
						this.renderRect(), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var ListenerMethods = __webpack_require__(163),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rect = React.createClass({displayName: "Rect",	
		...
		render: function() {
			...
			return (
				React.createElement("div", {className: classnames('rect center', {empty:  (!props.isActive && props.isBoom==false), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dialog = React.createClass({displayName: "Dialog",	
		...
		render: function() {		
			var maxnum =this.state.col_num*this.state.col_num-1;
			return (
				React.createElement("div", {className: "mask center"}, 
					React.createElement("div", {className: "dialog center", onClick: this.handleClick}, 	
						React.createElement("div", {className: "message"}, this.props.message), 
					    React.createElement("div", {className: "CInput"}, "ColNum : ", React.createElement("input", {className: "inputClass", min: "2", max: "40", type: "number", defaultValue: this.state.col_num, onChange: this.ColChange})), 
					    React.createElement("div", {className: "CInput"}, "MineNum : ", React.createElement("input", {className: "inputClass", type: "number", min: "1", max: maxnum, defaultValue: this.state.mine_num, onChange: this.MineChange})), 
						React.createElement("div", {className: "btn"}, "Next")
					)
				)
			);
		}
